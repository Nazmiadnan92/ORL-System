-- ORL OT Management System: hotfix Calendar Malaysia reader
-- Run once after 018 if Generate reported that no holidays could be read.
...
begin
  ...
  if p_year<2026 or p_year>2100 then raise exception 'Year must be between 2026 and 2100.'; end if;

  -- Reader bridge avoids Cloudflare returning a different page to the database.
  -- Only the public calendar URL is sent; no ORL or patient data leaves Supabase.
